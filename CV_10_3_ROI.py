'''THis creates a box with the mouseclick and then uses those values to creat a ROI
python -m venv .venv
...
while True:
    ...
    if evt  == 4:
        ...
        try:
            ...
            cv2.moveWindow('my ROI',int(width+1.5),int(100))
        except:
            pass
        print('pnt1_1: ',pnt1[1], ' pnt2_1: ', pnt2[1])
        print('pnt1_0: ',pnt1[0], ' pnt2_1: ', pnt2[0])
        print(ROI)
        # cv2.imshow('my ROI',ROI)
